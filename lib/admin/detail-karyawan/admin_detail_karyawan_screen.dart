...
class AdminDataKaryawanScreen extends StatefulWidget {
  ...
  @override
  State<AdminDataKaryawanScreen> createState() => _AdminDataKaryawanScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Data Karyawan',
          style: PoppinsTextStyle.bold.copyWith(fontSize: 20, color: Colors.black87),
        ),
        centerTitle: true,
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.badge_outlined, size: 14, color: Colors.grey[700]),
